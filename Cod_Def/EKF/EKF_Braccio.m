...
for j = 1:length(Dataset_Braccio)

    movim = Dataset_Braccio{j};
    posamov = [];
    stima = zeros(6,1);
...
%         end
        ...
        h_braccio = [h_fun(stima,ArmLocalCoords(1,:)); ...
...
tic
save('Dataset_Posestimate_Braccio', 'Dataset_Posestimate')
toc
