% function []=draw_coordinate_system(axis_length,Rotation_matrix,origin,rgb_value_matrix,cs_name)
...
line([origin(1);origin(1)+x_axis(1)],[origin(2);origin(2)+x_axis(2)],[origin(3);origin(3)+x_axis(3)],'color',rgb_value_matrix(1,:),'linewidth',2);
line([origin(1);origin(1)+y_axis(1)],[origin(2);origin(2)+y_axis(2)],[origin(3);origin(3)+y_axis(3)],'color',rgb_value_matrix(2,:),'linewidth',2);
line([origin(1);origin(1)+z_axis(1)],[origin(2);origin(2)+z_axis(2)],[origin(3);origin(3)+z_axis(3)],'color',rgb_value_matrix(3,:),'linewidth',2);
...
h=surf(X,Y,Z);
set(h,'facecolor',rgb_value_matrix(1,:));
...
h=surf(X,Y,Z);
set(h,'facecolor',rgb_value_matrix(2,:));
...
h=surf(X,Y,Z);
set(h,'facecolor',rgb_value_matrix(3,:));
...
if nargin==5, %add text labels
   ...
   text(x_label_pos(1),x_label_pos(2),x_label_pos(3),['X',cs_name],'FontWeight','bold','color','k');
   text(y_label_pos(1),y_label_pos(2),y_label_pos(3),['Y',cs_name],'FontWeight','bold','color','k');
   text(z_label_pos(1),z_label_pos(2),z_label_pos(3),['Z',cs_name],'FontWeight','bold','color','k');

%    text(x_label_pos(1),x_label_pos(2),x_label_pos(3),['',cs_name],'FontWeight','bold','color','k');
%    text(y_label_pos(1),y_label_pos(2),y_label_pos(3),['',cs_name],'FontWeight','bold','color','k');
%    text(z_label_pos(1),z_label_pos(2),z_label_pos(3),['',cs_name],'FontWeight','bold','color','k');
end;
return;
